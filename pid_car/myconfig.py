...
DRIVE_TRAIN_TYPE = "ARDUINO_DRIVE" #custom build drive by Peter Yesley
...
#
# #
# # Arduino Serial Drive
# #

ARDUINO_STEERING_LEFT_PWM = 6 #min and max values are 0-255
ARDUINO_STEERING_RIGHT_PWM = 82
ENCODER_CM_PER_TICK = .3115 #cm per tick of the encoder

# #
# # I2C_SERVO (deprecated in favor of PWM_STEERING_THROTTLE)
# #
STEERING_CHANNEL = 2            #(deprecated) channel on the 9685 pwm board 0-15
STEERING_LEFT_PWM = 146         #pwm value for full left steering
STEERING_RIGHT_PWM = 363       #pwm value for full right steering
...
THROTTLE_MAX = 1.0    # maximum throttle value the controller will produce
THROTTLE_MIN = 0.75   # minimum throttle value the controller will produce
