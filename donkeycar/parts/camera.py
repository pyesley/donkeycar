...
class PiCamera(BaseCamera):
    ...
    """
    def __init__(self, image_w=320, image_h=240, image_d=3,
        ...
        self.camera.set_controls({"FrameDurationLimits": (10, 1000)})
        logger.info("I am setting the gain")
        #gain = 8
        #exposure_time = 100000
        #self.camera.set_controls({"AnalogueGain": gain, "ExposureTime": exposure_time})
