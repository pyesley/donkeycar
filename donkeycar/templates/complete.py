...
def add_drivetrain(V, cfg):
    ...
    if (not cfg.DONKEY_GYM) and cfg.DRIVE_TRAIN_TYPE != "MOCK":
        ...
        elif cfg.DRIVE_TRAIN_TYPE == "ARDUINO_DRIVE":
            from donkeycar.parts.arduinoSerial import ArduinoThrottle, ArduinoSteering

            steering = ArduinoSteering( cfg.ARDUINO_STEERING_LEFT_PWM, cfg.ARDUINO_STEERING_RIGHT_PWM)
