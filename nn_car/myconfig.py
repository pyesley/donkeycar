...
SCAN_HEIGHT = 40      # num pixels high to grab from horiz scan
# Lower bound of the green color range
COLOR_THRESHOLD_LOW = (35, 50, 55)  # HSV values for dark green

# Upper bound of the green color range
COLOR_THRESHOLD_HIGH = (55, 255, 65)  # HSV values for bright green
# 
...
THROTTLE_MIN = 0.5   # minimum throttle value the controller will produce
